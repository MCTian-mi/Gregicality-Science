...
//        double potentialPressure = container.getPressureForGasAmount(container.getGasAmount() + increase);
...
//                NumberFormattingUtil.formatDoubleToCompactString(this.maxPressure), I18n.format(GCYSValues.PNF[GCYSUtility.getTierByPressure(this.maxPressure)])));
...
//        if (tier == GTValues.LuV) {
//            return GCYSTextures.SUPERSONIC_AXIAL_COMPRESSOR_OVERLAY;
//        }
//
//        return GCYSTextures.SUBSONIC_AXIAL_COMPRESSOR_OVERLAY;
//    }
//
//    @Override
