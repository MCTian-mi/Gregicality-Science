...
public class GCYSSecondDegreeMaterials {
    ...
    public static void init() {
        LaPrNdCeOxidesSolution = new Material.Builder(6000, gregtechId("la_pr_nd_ce_oxides_solution"))
                .fluid()
                .color(0x9CE3DB)
        ...
        YTbDyHoOxidesSolution = new Material.Builder(6002, gregtechId("y_tb_dy_ho_oxides_solution"))
                .fluid()
                .color(0x99FF99)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
        ...
        ErTmYbLuOxidesSolution = new Material.Builder(6003, gregtechId("er_tm_yb_lu_oxides_solution"))
                .fluid()
                .color(0xFFB3FF)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
        ...
        PlatinumGroupConcentrate = new Material.Builder(6004, gregtechId("platinum_group_concentrate"))
                .fluid()
                .color(0xFFFFA6)
        ...
        PlatinumGroupResidue = new Material.Builder(6005, gregtechId("platinum_group_residue"))
                .dust()
                .color(0x64632E)
        ...
        GrapheneOxide = new Material.Builder(6014, gregtechId("graphene_oxide"))
                .dust()
                .color(0x777777)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Wollastonite = new Material.Builder(6016, gregtechId("wollastonite"))
                .dust()
                .color(0xF0F0F0)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
        ...
        RoastedSphalerite = new Material.Builder(6017, gregtechId("roasted_sphalerite"))
                .dust()
                .color(0xAC8B5C)
        ...
        WaelzOxide = new Material.Builder(6018, gregtechId("waelz_oxide"))
                .dust()
                .color(0xB8B8B8)
                .iconSet(MaterialIconSet.FINE)
                .flags(DISABLE_DECOMPOSITION)
        ...
        WaelzSlag = new Material.Builder(6019, gregtechId("waelz_slag"))
                .dust()
                .color(0xAC8B5C)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        ImpureGermaniumDioxide = new Material.Builder(6020, gregtechId("impure_germanium_dioxide"))
                .dust()
                .color(0x666666)
                .iconSet(MaterialIconSet.ROUGH)
                .flags(DISABLE_DECOMPOSITION)
        ...
        ErbiumDopedZBLANGlass = new Material.Builder(6021, gregtechId("erbium_doped_zblan_glass"))
                .ingot()
                .color(0x505444)
        ...
        PraseodymiumDopedZBLANGlass = new Material.Builder(6022, gregtechId("praseodymium_doped_zblan_glass"))
                .ingot()
                .color(0xC5C88D)
                .iconSet(MaterialIconSet.BRIGHT)
                .flags(NO_SMASHING, NO_WORKING, DISABLE_DECOMPOSITION, GENERATE_PLATE)
        ...
        NdYAG = new Material.Builder(6023, gregtechId("nd_yag")) //TODO "Yttrium-Aluminium-Garnet" Tooltip
                .gem()
                .color(0xD99DE4)
        ...
        BismuthFerrite = new Material.Builder(6024, gregtechId("bismuth_ferrite")) //TODO "Multiferroic!" tooltip
                .gem()
                .color(0x43634B)
        ...
        ChromiumGermaniumTellurideMagnetic = new Material.Builder(6025, gregtechId("cgt_magnetic"))
                .ingot()
                .color(0x8F103E)
                .iconSet(MaterialIconSet.MAGNETIC)
        ...
        HeavyAlkaliChlorideSolution = new Material.Builder(6026, gregtechId("heavy_alkali_chloride_solution"))
                .fluid()
                .color(0x8F5353)
                .flags(DISABLE_DECOMPOSITION)
